...
function xmldb_local_greetings_upgrade($oldversion) {
    ...
    if ($oldversion < 2024052701) {
        ...
        // Define key greetings_user_foreign_key (foreign) to be added to local_greetings_messages.
        $key = new xmldb_key(
                'greetings_user_foreign_key',
                XMLDB_KEY_FOREIGN,
                ['userid'],
                'user',
                ['id']
        ...
        // Launch add key greetings_user_foreign_key.
        $dbman->add_key($table, $key);

        // Greetings savepoint reached.
        upgrade_plugin_savepoint(true, 2024052701, 'local', 'greetings');
    }
